    ...
    public class Cliente : Form
    {
        ...
        private void confirmarClienteButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Carteira_De_Clientes.Controllers.Client.AlterarCliente(this.txtId.Text, nomeCliente,telefoneCliente, enderecoCliente );
                    MessageBox.Show("Cliente atualizado com sucesso!");
                }
                else
                {
                    Carteira_De_Clientes.Controllers.Client.CadastrarCliente(nomeCliente, enderecoCliente, telefoneCliente);
        ...
        {
            Carteira_De_Clientes.Models.Cliente cliente = Carteira_De_Clientes.Controllers.Client.GetCliente(clienteId.ToString());
