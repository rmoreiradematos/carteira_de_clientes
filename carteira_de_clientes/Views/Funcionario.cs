    ...
    public class Funcionario : Form
    {
        ...
        private void adicionarFuncionarioButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    Carteira_De_Clientes.Controllers.User.AlterarFuncionario(this.txtId.Text, nome, email, role, salario);
                    MessageBox.Show("Funcionario atualizado com sucesso!");
                }
                else
                {
                    Carteira_De_Clientes.Controllers.User.CadastrarFuncionario(nome, maskedTxtSenha.Text, email, role, salario);
        ...
        {
            Carteira_De_Clientes.Models.Funcionario funcionario = Carteira_De_Clientes.Controllers.User.GetFuncionario(funcionarioId.ToString());
