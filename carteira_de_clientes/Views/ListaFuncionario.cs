...
namespace View
{
    public class ListaFuncionario : Form
    {
        ...
        private void PopulateDataGridView()
        {
            ...
            IEnumerable<Carteira_De_Clientes.Models.Funcionario> collectionFuncionarios = Carteira_De_Clientes.Controllers.User.GetAllFuncionarios();
        ...
        private void deletarFuncionarioButton_Click(object sender, EventArgs e)
        {
                ...
                this.funcionarioGridView.Rows.Count - 1)
            {
                ...
                if (confirmResult == DialogResult.Yes)
                {
                    ...
                    Carteira_De_Clientes.Controllers.User.ExcluirFuncionario(idFuncionario);
