...
namespace View
{
    public class ListaCliente : Form
    {
        ...
        private void PopulateDataGridView()
        {
            ...
            IEnumerable<Carteira_De_Clientes.Models.Cliente> collectionClientes = Carteira_De_Clientes.Controllers.Client.GetAllClientes();
        ...
        private void deletarClienteButton_Click(object sender, EventArgs e)
        {
                ...
                this.clienteGridView.Rows.Count - 1)
            {
                ...
                if (confirmResult == DialogResult.Yes)
                {
                    ...
                    Carteira_De_Clientes.Controllers.Client.ExcluirCliente(idCliente);
